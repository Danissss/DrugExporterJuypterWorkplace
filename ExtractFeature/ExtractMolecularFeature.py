...
def main():
	...
	# mol = GetMolFromSmiles("Cc1ccccc1",dimension=3)
	# print Generate2dDescriptor(mol,descriptorName)
	
	

	# Topliss Fragment return the number of fragement of molecules (-OH; etc.)

	# for i in range(len(DescValue)):
	# 	DescVa = DescValue[i]
	# 	if DescVa == 777:
	# 		print(descriptorName[i])
		# if i == str(777):
		# 	# print(inds)
		# 	print(type(descriptorName[inds]))
